    ...
    <main>
        <div class="container">
            <aside class="sidebar" id="sidebar">
                <nav>
                    ...
                    <ul>
                        ...
                        <li><a href="daftar_absen_masuk.php"><i class="fas fa-list"></i> Absensi Masuk </a></li>
                        <li><a href="daftar_absen_keluar.php"><i class="fas fa-list"></i> Absensi Keluar </a></li>
            ...
            <main id="main-content">
                ...
                <button><a href="tambah.php">Tambah karyawan baru</a></button><br>
